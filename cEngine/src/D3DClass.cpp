	...
	float screenDepth, float screenNear)
{
	...
	DirectX::XMMatrixPerspectiveFovLH(fieldOfView, screenAspect, screenNear, screenDepth);

	// Initialize the world matrix to the identity matrix.
	DirectX::XMMatrixIsIdentity(m_worldMatrix);

	// Create an orthographic projection matrix for 2D rendering.
	DirectX::XMMatrixOrthographicLH((float)screenWidth, (float)screenHeight, screenNear, screenDepth);
